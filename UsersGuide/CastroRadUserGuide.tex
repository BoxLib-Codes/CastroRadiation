...
\item {\tt radiation.Test\_Type\_lambda = 0}
  
  The gray solver only.  If {\tt 1}, save flux limiter.

\item {\tt radiation.Test\_Type\_Flux = 0}
  
  If {\tt 1}, save the total radiation flux.
\end{itemize}
